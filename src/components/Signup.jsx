...
const Signup = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      userDispatch({ type: "REGISTER_USER", payload: data });
  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-1 h-[100vh]">
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <p className="mt-2 text-base text-gray-600">
              ...
              <Link
                to="/login"
                className="font-medium text-black transition-all duration-200 underline"
              >
                Sign In
              </Link>
            </p>
